...
相信你也看注意到，上面的例子我们给出的是基于 nginx-Ingress-controller 的七层流量切分方案，另外我们也支持了 Kubernetes Gateway 的 API （[https://gateway-api.sigs.k8s.io/](https://gateway-api.sigs.k8s.io/)）从而能够支持更多的网关类型和四层的流量切分方案。
